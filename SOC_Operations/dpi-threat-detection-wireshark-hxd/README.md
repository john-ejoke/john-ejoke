# Deep Packet Inspection for Cyber Threat Detection Using Wireshark and HxD

> **Repo:** `SOC-Operations/dpi-threat-detection-wireshark-hxd/`
...
4. [Step 1 - Loading the PCAP and Filtering HTTP Traffic](#4-step-1---loading-the-pcap-and-filtering-http-traffic)
...
7. [Step 4 - Extracting Raw Hex and Carving the File in HxD](#7-step-4---extracting-raw-hex-and-carving-the-file-in-hxd)
8. [Step 5 - Reconstructing and Confirming the Exfiltrated File](#8-step-5---reconstructing-and-confirming-the-exfiltrated-file)
...
## 4. Step 1 - Loading the PCAP and Filtering HTTP Traffic
...
## 7. Step 4 - Extracting Raw Hex and Carving the File in HxD
...
## 8. Step 5 - Reconstructing and Confirming the Exfiltrated File
...
| **Network Monitoring and SIEM** | Alert on large volumes of image/document file transfers to unusual destinations, or transfers of files with suspicious naming patterns |
...
| **PCAP Retention and Forensics Capability** | This investigation was only possible because a full PCAP was available organisations should retain network capture capability for incident response |
...
| JPEG File Format and Magic Bytes | https://en.wikipedia.org/wiki/JPEG#Syntax_and_structure |
| SANS - Network Forensics and Packet Analysis | https://www.sans.org/white-papers/33920/ |
...
* Ejoke John | [LinkedIn](https://www.linkedin.com/in/john-ejoke/) | [GitHub](https://github.com/john-ejoke)*
